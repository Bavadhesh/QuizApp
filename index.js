...
mongoose
  ...
  .then(() => {
    ...
    que.create({ Uid: 'test1', Que: 'Sample Question', Opt1: 'A', Opt2: 'B', Opt3: 'C', Opt4: 'D', Correct: 'A', Testno: '1' });
    user.create({ Name: 'Test User', Email: 'testuser@example.com', Password: 'password', Phone: '1234567890' });
    admin.create({ Name: 'Admin User', Email: 'admin@example.com', Password: 'adminpass' });
    admin.create({ Name: 'Test User', Email: 'testuser@example.com', Password: 'password', Phone: '1234567890' });
    record.create({ TestNo: '1', Name: 'Test User', Email: 'testuser@example.com', Maxmarks: '100', Marks: '95', Percentage: '95%', Status: 'Pass', Date: '2024-11-07' });
  })
  .catch(error => {
    console.log(error);
  });
